...
// 모든 전투 상대를 '페트'로 통칭
const MONSTERS = {
  rat:        { id:'rat',        name:'크리퍼',      emoji:'🐀', hp:14,  atk:5,  def:1,  spd:10, exp:8   },
  slime:      { id:'slime',      name:'글로비',      emoji:'🟢', hp:28,  atk:8,  def:3,  spd:4,  exp:15  },
  bat:        { id:'bat',        name:'쉐이드',      emoji:'🦇', hp:20,  atk:12, def:2,  spd:12, exp:18  },
